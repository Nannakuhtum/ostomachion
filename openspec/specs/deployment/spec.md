...
## Purpose
Build and deployment of Ostomachion as a GitHub Pages project site at `https://games.aakkagam.com/ostomachion/`, including static bundle correctness, CI deploy workflow, page metadata, and structured data.
