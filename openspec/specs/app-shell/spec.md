...
## Purpose
The Ostomachion app shell: a Svelte 5 + TypeScript + Vite single-screen application implementing the DESIGN.md visual system, with mode tabs and a responsive board area.
